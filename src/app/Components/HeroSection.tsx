    ...
    <div className="relative min-h-screen overflow-hidden" style={{backgroundColor: '#F3F8FF'}}>
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-6">
        <div className="text-center max-w-4xl mx-auto">
          {/* Main heading */}
          <h1 className=" text-4xl font-kantumruy mb-8 leading-tight" style={{color: '#234285'}}>
            The Future is Quantum. Start building it at QCSA.
          </h1>
          
          {/* Description */}
          <p className=" mb-12 max-w-2xl text-4xl mx-auto leading-relaxed font-kantumruy" style={{color: '#234285'}}>
