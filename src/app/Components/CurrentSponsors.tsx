...
const CurrentSponsors = ({ 
  ...
  return (
    <>
      ...
      <section className="w-full max-w-full py-8" style={{ backgroundColor: '#F3F8FF' }} aria-label="Sponsor carousel" >
        <div className="w-full max-w-full px-4">
          ...
          >
            ...
            {/* Scrolling container */}
            <div 
              className={`flex nowrap ${!reducedMotion ? (direction === 'left' ? 'animate-scroll-left' : 'animate-scroll-right') : ''}`}
            ...
            >
              ...
              {/* Third set for seamless loop - ensures no gaps */}
              {sponsors.map((sponsor, index) => (
                <a
                  key={`third-${index}`}
                  href={sponsor.url}
