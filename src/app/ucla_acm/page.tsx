...
const FALL_QUARTER_2025 = [
  ...
  {
    title: "Week 2: Quantum Gates, Circuits, Identities, and Quantum Protocols",
    href: "https://www.youtube.com/watch?v=U4B3_kf3l6w",
  },
  { title: "Week 3: Deutsch-Josza Algorithm", href: "https://www.youtube.com/watch?v=Cb2quQh_lXQ" },
  {
    title: "Week 5: Entanglement, Magic & Magic State Distillation",
    href: "https://drive.google.com/file/d/1xN6Sx9r-pVAsWhsXVPTpKveF6D-m6MVQ/view?usp=sharing",
  },
];
...
const PAST_SEMINARS = [
  {
    ...
    href: "https://drive.google.com/file/d/14X4zg8485xQI8Yjs3QbWn2NqbVCjmfGL/view",
  },
  {
...
export default function Page() {
  ...
  const scrollBy = (ref: React.RefObject<HTMLDivElement | null>, direction: number) => {
      ...
      <main className="py-20 px-6 sm:px-8 lg:px-16 flex-grow">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <section className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-8 items-center py-6 md:py-12">
            ...
            >
              <div className="w-full flex flex-col items-center justify-center gap-10 md:gap-12 px-6 py-10">
                <div className="relative w-[180px] md:w-[300px] h-[90px] md:h-[140px]">
                  <Image
                    src="/images/acm_q.png"
                    alt="ACM Quantum"
                    fill
                    priority
                    quality={100}
            ...
            >
              ...
              <p className="text-1/2xl mt-4 gap-25">
                New to quantum? Join our quarterly seminar series in collaboration with ACM (Association for Computer
                Machinery)! The series focuses on quantum information science, including quantum computers, sensors, and
                algorithms. This collaboration brings you an accessible introduction to this revolutionary field. No
                prior experience needed—our approach emphasizes intuitive understanding with hands-on projects throughout
                the series. What you’ll explore:
              </p>

              <ul className="mt-8 list-disc pl-6 text-sm md:text-base">
              ...
              <p className="text-1/2xl mt-6 font-bold">
                Winter 2026 Meetings @ Math. Sci. 5147 on Tuesdays from 6 - 8pm
              </p>

              <h3 className="text-2xl font-kantumruy mt-6">Projects Track.</h3>

              <p className="text-1/2xl mt-4 gap-25">
                Gain experience contributing to open-source code! Learn how to use Git and QASM by implementing
                algorithms (decided by you!) with the ACM Quantum team to the qbraid-algorithms repo.
              </p>

              <p className="text-1/2xl mt-4 font-bold">
                Winter 2026 Meetings @ Ackerman Union, Meeting Room 3508 on even-week Thursdays from 6 - 8pm.
              </p>
            </motion.div>
          </section>
          ...
          >
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-8 md:mb-12">
                <h2 className="text-3xl md:text-4xl font-bold text-[#234285] mb-4 font-kantumruy">Ready to Join Us?</h2>
              ...
              <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-blue-100">
                ...
                <div className="p-4 md:p-6">
                  ...
                  <div className="mt-6 text-center">
                    <p className="text-sm text-gray-600 mb-4">Having trouble with the form above?</p>
                    <Link
              ...
              <div className="mt-8 text-center">
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center text-sm text-[#234285] opacity-70">
                  <FeatureItem text="Free to attend" />
                  <FeatureItem text="No experience required" />
                  <FeatureItem text="Materials provided" />
                </div>
              </div>
            </div>
          </motion.section>
          ...
          <motion.section
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-center text-2xl md:text-3xl font-bold text-[#234285] mb-6 md:mb-8 font-kantumruy">
              Fall Quarter 2025
            </h2>
            ...
            <div className="relative">
              ...
              <div
                ref={fallRef}
                className="flex gap-4 md:gap-8 overflow-x-auto snap-x snap-mandatory scroll-smooth py-6 px-4 md:px-6 sm:px-0"
              >
                  ...
                  <div key={i} className="snap-start flex-shrink-0 w-[280px] sm:w-[46%] lg:w-[31%]">
                    <div className="relative">
                      <div
                        ...
                        style={{ boxShadow: "0 10px 30px rgba(49,100,180,0.12)" }}
                      />
                      <article
                        className="relative bg-white rounded-md p-6 md:p-8"
                        style={{
                      ...
                      >
                        ...
                        <div className="flex justify-center">
                          <Link
                            href={s.href}
                            className="bg-blue-900 text-white px-4 md:px-6 py-2 md:py-3 rounded shadow-sm hover:bg-blue-800 font-kantumruy text-2xl"
                          >
                            Learn More
                          </Link>
                        </div>
